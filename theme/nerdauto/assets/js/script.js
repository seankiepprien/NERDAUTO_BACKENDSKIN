document.addEventListener("DOMContentLoaded", () => {
    ...
    toggleTheme.innerHTML = `<div class="checkbox custom-checkbox" style="margin:5px 30px 4px"><label for="darkTheme" style="color: #fff">Dark Theme</label></div>`;
    ...
    document.querySelector('.mainmenu-submenu-dropdown li.mainmenu-item').before(toggleTheme);
